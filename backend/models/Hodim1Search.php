...
use backend\models\Hodim1;

/**
 * Hodim1Search represents the model behind the search form of `backend\models\Hodim1`.
 */
class Hodim1Search extends Hodim1
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'lav', 'cate'], 'integer'],
            [['name_uz', 'name_ru', 'name_en', 'lav_uz', 'lav_ru', 'lav_en', 'ilm_uz', 'ilm_ru', 'ilm_en', 'ilm1_uz', 'ilm1_ru', 'ilm1_en', 'tel', 'email', 'text_uz', 'text_ru', 'text_en', 'img', 'scholar'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name_uz', $this->name_uz])
            ...
            ->andFilterWhere(['like', 'scholar', $this->scholar]);
