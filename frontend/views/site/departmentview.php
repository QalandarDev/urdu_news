            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <?php foreach ($news as $item) { ?>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="<?= $item->img ?>" alt="<?= mb_substr($item[$newtitle], 0, 150) ?>"
                                             style="height: 200px;
												width: 100%;
												object-fit: cover;
												margin-right: 50px;
                                    ...
                                    <div class="col-md-8" style="margin-top: -15px">
                                        <div class="blog-content">
                                            <p><a id="h"
                                                  href="<?= Url::to(['/site/view?id=' . $item->id]) ?>"><?= mb_substr($item[$newtitle], 0, 150) ?>
                                                    ...</a></p>
                                            <small><i class="fa fa-calendar"></i><?= $item['date'] ?></small>
                                            <p id="st"><?= mb_substr(strip_tags($item[$newtext], '<p>'), 0, 150) ?>
                                                ...</p>
                                            <a href="<?= Url::to(['/site/view?id=' . $item->id]) ?>"
                                               class="btn-style pull-right"><?= $more ?></a><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="4" class="tab-pane">
                    <?php if (isset($_GET["id"]) and $_GET["id"] == 37 or $_GET["id"] == 36 or $_GET["id"] == 77) { ?>
                        <div class="rg-plugin" data-stats="true" data-faces="true" data-publications="true"
                             data-height="600"
