        ...
        <?= Yii::t('app', 'ADMISSION 2022 CALL-CENTER') ?></h3>
                                            ...
                                            <div style="opacity:0.5; background-color:white;">
                                                <div style="opacity:1.0;">
                                                    <a style="color: red; font-weight: bold;  font-size: 18px" id="st"> <?= Yii::t('app','Diqqat!!! Ijodiy imtihon topshiruvchi abituriyentlarning 1-avgust holatiga ko\'ra imtihonda natijalari e\'lon qilindi') ?></a><br><br>
