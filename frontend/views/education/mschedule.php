...
$this->params['breadcrumbs'][] = Yii::t('app', "Talabalar");
$this->params['breadcrumbs'][] = Yii::t('app', "Magistratura");
    ...
    <section class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <?php $form = ActiveForm::begin(['method' => 'get','action' => Url::to(['education/schedule'])]); ?>
                <div class="col-md-4">
                    <?=
                ...
                <div class="col-md-4">
                    <?= $form->field($model, 'group')->widget(DepDrop::class, [
                        ...
                        'data' => $model->listMschedule(),
                        'pluginOptions' => [
                            'depends' => ['course-id'],
                            'placeholder' => '-- Guruh Tanlash --',
                            'url' => Url::to(['/education/subcat1'])
                        ]
                    ])->label(false) ?>
                </div>
                <div class="col-md-4">
...
//                    echo $html;
                ...
                <div class="header-bottom-right text-right" style="margin-bottom: 0">
                    <a href="https://t.me/urdudarsjadvalibot" target="_blank" style="font-size: 2rem"><i
                                class="fa fa-telegram">UrDU Dars Jadvali telegram botiga kirish</i></a>
                </div>
            </div>
        </div>
