...
/* @var $model \backend\models\Events|null */
...
<div style="float: right !important; margin-top:20px;">
    <a target="_blank"
       href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Furdu.uz%2F<?= $lang ?>%2Fviews%3Fid%3D<?= $model['id'] ?>&amp;src=sdkpreparse"
       class="btn btn-info"><i class="fa fa-facebook"></i></a></div>
